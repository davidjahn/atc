...
type FakeWorkerFactory struct {
	...
	LandWorkerStub        func(name string) error
...
func (fake *FakeWorkerFactory) LandWorker(name string) error {
...
func (fake *FakeWorkerFactory) LandWorkerReturns(result1 error) {
